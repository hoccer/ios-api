...
# Define these to suit your nefarious purposes
                 FRAMEWORK_NAME=Hoccer
                       LIB_NAME=libHoccerLib
              FRAMEWORK_VERSION=A
                     BUILD_TYPE=Release
...
cp Classes/HoccerClient/*.h $FRAMEWORK_DIR/Headers/
cp Classes/HoccerClient/EnvironmentController/*.h $FRAMEWORK_DIR/Headers/
cp Classes/HoccerClient/HttpClient/*.h $FRAMEWORK_DIR/Headers/
