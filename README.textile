...
- (void)viewDidLoad {
	client = [[HCClient alloc] initWithApiKey: @"1234567890" secret: @"geheim!!!11elf"];
	client.delegate = self;
}

- (IBAction)send: (id)sender {
	NSDictionary *payload = [NSDictionary dictionaryWithObject: @"World" forKey: @"Hello"];
	[client send: payload withMode: HCTransferModeDistribution];
}

- (IBAction)receive: (id)sender {
	[client receiveWithMode: HCTransferModeDistribution];
}
